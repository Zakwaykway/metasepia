...
fp.push(`(pad "2" thru_hole roundrect (at 13 ${flipN(flip, 0)} ${flipR(flip, p.r + 0)}) (size 3.5 3.8) (drill 0.4) (layers "*.Cu" "*.Mask") (remove_unused_layers no) (roundrect_rratio 0.36) (chamfer_ratio 0.013) (chamfer top_left bottom_left)  ${p.BAT_POS})`);

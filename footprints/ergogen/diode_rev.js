...
// Pads
fp.push(`(pad "1" smd roundrect (at -1.775 ${flipN(flip, 0)} ${flipR(flip, p.r + 0)}) (size 1.3 0.95) (layers "${(flip ? "B" : "F")}.Cu" "${(flip ? "B" : "F")}.Mask" "${(flip ? "B" : "F")}.Paste") (roundrect_rratio 0.25)  ${p.from})`);
fp.push(`(pad "1" smd roundrect (at -1.775 ${flipN(flip, 0)} ${flipR(flip, p.r + 0)}) (size 1.3 0.95) (layers "${(flip ? "F" : "B")}.Cu" "${(flip ? "F" : "B")}.Mask" "${(flip ? "F" : "B")}.Paste") (roundrect_rratio 0.25)  ${p.from})`);
fp.push(`(pad "1" thru_hole oval (at -0.85 ${flipN(flip, 0)} ${flipR(flip, p.r + 0)}) (size 1 0.5) (drill 0.3 (offset -0.25 0)) (layers "*.Cu") (remove_unused_layers no)  ${p.from})`);
fp.push(`(pad "2" thru_hole oval (at 0.85 ${flipN(flip, 0)} ${flipR(flip, p.r + 180)}) (size 1 0.5) (drill 0.3 (offset -0.25 0)) (layers "*.Cu") (remove_unused_layers no)  ${p.to})`);
fp.push(`(pad "2" smd roundrect (at 1.775 ${flipN(flip, -0.0004)} ${flipR(flip, p.r + 0)}) (size 1.3 0.95) (layers "${(flip ? "B" : "F")}.Cu" "${(flip ? "B" : "F")}.Mask" "${(flip ? "B" : "F")}.Paste") (roundrect_rratio 0.25)  ${p.to})`);
fp.push(`(pad "2" smd roundrect (at 1.775 ${flipN(flip, -0.0004)} ${flipR(flip, p.r + 0)}) (size 1.3 0.95) (layers "${(flip ? "F" : "B")}.Cu" "${(flip ? "F" : "B")}.Mask" "${(flip ? "F" : "B")}.Paste") (roundrect_rratio 0.25)  ${p.to})`);
